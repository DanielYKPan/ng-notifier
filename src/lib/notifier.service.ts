...
export class NotifierService {
    ...
    public clear( notice?: Notice ): void {
        if (!this.container) {
            return;
        }
    ...
    private set( notice: Notice, options?: Object ): Notice {
        ...
        if (!this.container) {
            ...
            let notifierFactory = this.componentFactoryResolver
                .resolveComponentFactory(NotifierContainerComponent);
